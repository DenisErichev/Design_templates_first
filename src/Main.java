...
//        lstThread.add(new Thread(createDate(sem)));
//        lstThread.add(new Thread(createDate(sem)));
...
//        GenerationData data1 = createDate(sem);
//        GenerationData data2 = createDate(sem);
//        lst.add(new Thread(createDate(sem)));
//        lst.add(new Thread(createDate(sem)));
...
//        Semaphore customerLock =  new Semaphore(0);
//
//        GenerationData saloon = createDate(noOfWaitingChairs,barberLock,customerLock);
//        Barber barber = new Barber(barberLock,customerLock,saloon);
//
...
//        System.out.print("Введите тип с которым хотите работать: целое или строковое: ");
//        String type2 ="";
//        type2 = checkInputCommand(type2,sc);
//        System.out.print("Введите колличество элементов: ");
//        counterElements = CheckMethods.checkInputNum();
//        return new GenerationData(noOfWaitingChairs,barberLock,customerLock,type1,type2,counterElements);
//    }
//}